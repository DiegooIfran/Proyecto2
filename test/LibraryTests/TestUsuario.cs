...
public class TestUsuario
{
    ...
    {
        var vendedor = new Vendedor("Lautaro", "Ramirez", "092773311", "lautaro.ramirez@gmail.com", ".luty");
        ...
        Assert.AreEqual(".luty", vendedor.ObtenerNick());
    }

    [Test]
    public void InstanciasDe() // Verifico que administrador y vendedor sean instancias de usuario
    {
        Usuario administrador = new Administrador("Carlos", "Diaz", "3213138", "carlosdiaz@gmail.com", ".luty");
        Assert.IsInstanceOf<Usuario>(administrador);
        
        Usuario vendedor= new Vendedor("Federico", "Garcia", "231231", "fedegarcia@gmail.com", ".luty");
