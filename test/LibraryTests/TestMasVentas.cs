...
public class TestMasVentas
{
    ...
    Fachada _fachada = Singleton<Fachada>.Instance;
    ...
    [Test]
    public void FachadaCalcularBono() //Verifica si la fachada implementa correctamente el bono al vendedor con más ventas
    {
        Vendedor vendedor0 = new Vendedor("Lautaro", "Ramirez", "092773311", "lautaro.ramirez@gmail.com", ".luty");
        Cliente cliente0 = new Cliente("Juan", "Perez", "0923", "juan@gmail.com","hombre", DateTime.Today);
        gv.Agregar(vendedor0);
        ...
        Assert.That(_fachada.CalcularBonoMasVentas(),Is.EqualTo(300));
    }
    [Test]
    public void FachadaCantidadVentas() //Verifica si la fachada implementa correctamente la HdU para obtener la cantidad de ventas de un vendedor
    {
        ...
        Assert.That(_fachada.CantidadVentasDelVendedor(".luty"),Is.EqualTo(3));
        Assert.That(_fachada.CantidadVentasDelVendedor("buendia."),Is.EqualTo(2));
    }
    [Test]
    public void FachadaMasVentas() //Verifica si la fachada implementa correctamente la HdU para obtener el vendedor con más ventas
    {
        Vendedor vendedor0 = new Vendedor("Lautaro", "Ramirez", "092773311", "lautaro.ramirez@gmail.com", ".luty");
        Cliente cliente0 = new Cliente("Juan", "Perez", "0923", "juan@gmail.com","hombre", DateTime.Today);
        gv.Agregar(vendedor0);
        ...
        Assert.That(_fachada.VendedorConMasVentas(),Is.EqualTo(vendedor0));
    }
}